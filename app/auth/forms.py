...
class RegistrationForm(FlaskForm):
    empid = IntegerField('Employee Id', validators=[DataRequired()])
    ...
    login = TimeField('LogIn-Time', validators=[DataRequired()])
    logout = TimeField('LogOut-Time', validators=[DataRequired()])
